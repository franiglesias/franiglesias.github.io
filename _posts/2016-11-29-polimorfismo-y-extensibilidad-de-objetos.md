...
Otro ejemplo: todos los empleados de una empresa son de la clase "Empleados", pero pueden desempeñar distintos puestos, que definen responsabilidades, salarios, beneficions, etc. Cuando les pedimos que "trabajen" cada uno hace lo que le corresponde.
