...
Uno de los primeros pasos para mantener esa complejidad bajo control es identificar los llamados **bounded contexts** o contextos acotados. Un *bounded context* es una parte de un dominio en la que viven conceptos y procesos propios, que no se participan en otras partes, y en la que los conceptos generales, compartidos entre varios contextos, pueden tener un significado distinto.
