...
Esta implementación nos permite pasar el test, pero es un poco sucia. Fíjate que hemos aprovechado para dar soporte al evento QUIT, que permite cerrar la ventana del juego con los atajos del sistema operativo.
