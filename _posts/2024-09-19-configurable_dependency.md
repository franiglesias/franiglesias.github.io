...
La inversión de control consiste en introducir una abstracción y depender de ella en lugar de una implementación concreta. Nosotras representamos estas abstracciones con interfaces:
